...
public class ReadMatchDto {
    ...
    private List<ReadMatchEventPickDto> matchOutComes=new ArrayList<>();
    ...
    public List<ReadMatchEventPickDto> getMatchOutComes() {
         return matchOutComes;
    }

    public void setMatchOutComes(List<ReadMatchEventPickDto> matchOutComes) {
