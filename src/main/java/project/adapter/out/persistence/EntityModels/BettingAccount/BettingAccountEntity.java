...
public class BettingAccountEntity {
    ...
    @ElementCollection
    private List<BonusEmb> bonuses = new ArrayList<>();
    ...
    public void addBonusEmb(BonusEmb b) {
        this.bonuses.add(b);
    }
    ...
    public List<BonusEmb> getBonuses() {
        return bonuses;
    }

    public void setBonuses(List<BonusEmb> bonuses) {
